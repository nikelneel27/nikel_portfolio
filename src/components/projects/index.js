        ...
        <section className="featured" id="Work">
            ...
            <div className="left">
                <div className="inner transition2">
                    ...
                    <p className="featured-desc">Technologies used :  HTML, CSS, Java Script, Vue, Charts used- Echart </p>
                </div>
            </div>
            ...
            <div className="left">
                <div className="inner transition2">
                    ...
                    <p className="featured-desc">Technologies used :  HTML, CSS, Java Script, Vue, Bootstrap, Unsplash Apis, Firebase</p>
                </div>
            </div>
